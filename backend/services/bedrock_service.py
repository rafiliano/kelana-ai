...
def get_ai_recommendation(days: int, destination: str, budget: float, travel_style: str) -> str:
    ...
    prompt = (
        ...
        f"Please provide:\n"
        f"- Daily itinerary with:\n"
        f"  - Morning activities: 2-3 activities per day\n"
        f"  - Afternoon activities: include cultural sites and experiences\n"
        f"  - Evening activities: suggest dinner spots and nightlife\n"
